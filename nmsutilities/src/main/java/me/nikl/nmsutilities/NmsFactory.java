...
import nmsutilities.NmsUtility_1_20_R1;
...
public class NmsFactory {
    ...
    public static NmsUtility getNmsUtility() {
        ...
        switch (VERSION) {
            ...
            case "v1_16_R3":
                return nmsUtility = new NmsUtility_1_16_R3();
            case "v1_17_R1":
                return nmsUtility = new NmsUtility_1_17_R1();
            case "v1_18_R1":
                return nmsUtility = new NmsUtility_1_18_R1();
            case "v1_18_R2":
